...
public static partial class NopCatalogDefaults
{
    ...
    /// <summary>
    /// Key for caching same category products
    /// </summary>
    /// <remarks>
    /// {0} : product id
    /// {1} : max results
    /// </remarks>
    public static CacheKey SameCategoryProductsCacheKey => new("nop.product.samecategory.{0}-{1}", SameCategoryProductsPrefix);
    public static string SameCategoryProductsPrefix => "nop.product.samecategory.";
