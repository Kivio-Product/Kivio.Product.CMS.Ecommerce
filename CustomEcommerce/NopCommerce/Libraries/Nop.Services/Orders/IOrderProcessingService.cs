...
public partial interface IOrderProcessingService
{
    ...
    /// </returns>
    Task<bool> ValidateMinOrderSubtotalAmountAsync(IList<ShoppingCartItem> cart, int? storeId = null);
    ...
    /// </returns>
    Task<bool> ValidateMinOrderTotalAmountAsync(IList<ShoppingCartItem> cart, int? storeId = null);
