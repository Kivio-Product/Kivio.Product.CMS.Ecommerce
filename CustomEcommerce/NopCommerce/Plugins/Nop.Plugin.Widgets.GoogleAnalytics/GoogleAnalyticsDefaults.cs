...
public static class GoogleAnalyticsDefaults
{
    ...
    /// <summary>
    /// Gets a name of the site visit event
    /// </summary>
    public static string SiteVisitEventName => "site_visit";

    /// <summary>
    /// Gets the platform type for TWA (Trusted Web Activity)
    /// </summary>
    public static string PlatformTwa => "twa_app";

    /// <summary>
    /// Gets the platform type for Web browser
    /// </summary>
    public static string PlatformWeb => "web_browser";
