    ...
    public class SiigoPlugin : BasePlugin, IMiscPlugin
    {
        ...
        private async Task InstallLocalizationResourcesAsync()
        {
            await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
            {
                ...
                ["Plugins.ElectronicInvoice.SIIGO.Fields.BearerToken"] = "Bearer Token",
                ["Plugins.ElectronicInvoice.SIIGO.Fields.BearerToken.Hint"] = "Bearer authentication token for SIIGO API",
