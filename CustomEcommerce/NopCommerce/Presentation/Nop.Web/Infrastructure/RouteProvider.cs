...
public partial class RouteProvider : BaseRouteProvider, IRouteProvider
{
    ...
    public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
    {
        ...
        endpointRouteBuilder.MapControllerRoute(name: "OrderCancelled",
        pattern: $"{lang}/checkout/cancelled/{{orderId:int?}}",
        defaults: new { controller = "Checkout", action = "Cancelled" });
