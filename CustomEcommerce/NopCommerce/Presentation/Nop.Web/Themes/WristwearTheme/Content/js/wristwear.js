/*!
 * Wristwear Theme v2.9.0 (http://themes.nopaccelerate.com/themes/wristwear-nopcommerce-theme/)
...
$(function () {
    ...
    $('.block .title,.column .title,.product-filter .filter-title').on('click', function () {
