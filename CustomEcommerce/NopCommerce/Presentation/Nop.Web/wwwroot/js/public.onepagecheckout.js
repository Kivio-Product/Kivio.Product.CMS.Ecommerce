/*
** nopCommerce one page checkout with SweetAlert
** Requiere SweetAlert2: https://cdn.jsdelivr.net/npm/sweetalert2@11
*/

// Función helper para mostrar alertas con SweetAlert
...
var ShippingMethod = {
    ...
    validate: function () {
        ...
        if (methods.length === 0) {
            showAlert(this.localized_data.NotAvailableMethodsError);
            return false;
        }
        ...
        showAlert(this.localized_data.SpecifyMethodError);
        return false;
    },
...
var DeliveryTime = {
    ...
    validate: function () {       
        ...
        if (!selectedDate || !selectedMinTime || !selectedMaxTime) {
            console.error('Validation FAILED - missing values');
